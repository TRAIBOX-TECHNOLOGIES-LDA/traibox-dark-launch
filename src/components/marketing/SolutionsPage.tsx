...
import { Briefcase, Globe, Banknote, Building2, ArrowRight } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 md:p-8 max-w-2xl mx-auto"
      >
