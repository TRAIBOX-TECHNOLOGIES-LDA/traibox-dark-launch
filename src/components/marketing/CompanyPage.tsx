    ...
    >
        ...
        >
          ...
          <div className="space-y-3">
            <a
              ...
              className="flex items-center justify-between rounded-2xl border border-white/15 bg-white/5 px-4 py-3 text-sm text-white hover:bg-white/10 transition"
            >
            ...
            <Link
              to="/request-access"
              className="flex items-center justify-between rounded-2xl bg-white px-4 py-3 text-sm font-medium text-black hover:bg-white/90 transition"
            >
              Request access
              <ArrowRight className="h-4 w-4" />
            </Link>
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {["Privacy Policy", "Terms", "DPA / SLA"].map((item) => (
            <a
              key={item}
              href="#"
