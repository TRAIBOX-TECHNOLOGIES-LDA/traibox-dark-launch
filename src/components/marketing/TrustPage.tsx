...
import { Shield, Lock, FileCheck2, Check } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          <h3 className="text-lg font-semibold text-foreground mb-3">Operational readiness</h3>
        ...
        <motion.div
          ...
          className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 md:p-8"
        >
          <h3 className="text-lg font-semibold text-foreground mb-3">Responsible AI</h3>
          <p className="text-sm text-muted-foreground mb-4">
